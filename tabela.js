...
function adversario() {
	...
	document.getElementById("confrontoMeuTime").style.outline = "2px solid " + coresTimes(time)[1];
	...
	document.getElementById("confrontoAdversario").style.outline = "2px solid " + coresTimes(adversario)[1];
