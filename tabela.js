...
var jogo41 = ["Flamengo", "Botafogo", 1, 0, "Carioca", "2013-02-17", "Nilton Santos", "Oswaldo de Oliveira", "", "-Hernane"];
jogos.push(jogo41);
var jogo42 = ["Botafogo", "Fluminense", 1, 0, "Carioca", "2013-05-05", "Raulino de Oliveira (Volta Redonda-RJ)", "Oswaldo de Oliveira", "-Rafael Marques", ""];
jogos.push(jogo42);
var jogo43 = ["Botafogo", "Grêmio", 0, 1, "Série A", "2013-10-05", "Maracanã", "Oswaldo de Oliveira", "", "-Alex Telles"];
jogos.push(jogo43);
var jogo44 = ["Botafogo", "Criciúma", 3, 0, "Série A", "2013-12-08", "Maracanã", "Oswaldo de Oliveira", "-Lodeiro<br/>-Elias<br/>-Seedorf", ""];
jogos.push(jogo44);
var jogo45 = ["Botafogo", "Deportivo Quito-EQU", 4, 0, "Copa Libertadores", "2014-02-05", "Maracanã", "Eduardo Húngaro", "-Wallyson (3x)<br/>-Henrique Almeida", ""];
jogos.push(jogo45);
...
jogos.push(jogo195);
var jogo196 = ["Fluminense", "Botafogo",  3, 0, "Carioca", "2020-02-09", "Maracanã", "Alberto Valentim", "", "-Nenê (2x)<br>-Wellington Silva"];
jogos.push(jogo196);
